module scinstmem (a,inst); 
	...
	assign	rom[5'h06] = 32'h01244022;	// (18) sub r8,r9,r4  ← 修复：原为 r9. r4
	...
	assign	rom[5'h17] = 32'h08000017;	// (5c) finish: j finish  ← 修复：原为 nop
	...
	assign	rom[5'h1D] = 32'h14a0fffb;	// (74) bne r5,r0,loop  ← 修复：原为 rS
	assign	rom[5'h1E] = 32'h00081000;	// (78) sll r2,r8,0  ← 修复：原为 r2f r8f
